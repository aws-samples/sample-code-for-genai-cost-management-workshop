...
def main():
    ...
    print("  You can now run 4-2_invoke_models.py to make inference calls through the projects.")
    print()
    print("  Next steps:")
    print("  1. Run 4-2_invoke_models.py to invoke models through projects")
